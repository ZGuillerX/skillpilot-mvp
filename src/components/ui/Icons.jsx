...
export const FireIcon = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="currentColor" viewBox="0 0 24 24">
    <path d="M12 2c1.131 0 2 .865 2 2 0 1.196-.724 2.235-1.75 2.685.984.398 1.75 1.382 1.75 2.565 0 1.382-1.056 2.5-2.357 2.5H8.357C7.056 11.75 6 10.632 6 9.25c0-1.183.766-2.167 1.75-2.565C6.724 6.235 6 5.196 6 4c0-1.135.869-2 2-2 .535 0 1.018.209 1.382.549C9.744 2.209 10.227 2 10.762 2c.535 0 1.018.209 1.382.549C12.508 2.209 12.991 2 13.526 2c1.131 0 2 .865 2 2z" />
    <path d="M12 14v8" />
  </svg>
);
...
export const CrownIcon = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="currentColor" viewBox="0 0 24 24">
    <path d="M12 2L8 8l-6-2 2 12h16l2-12-6 2-4-6zm0 4.5L14 9l4-1-1.5 9h-9L6 8l4 1 2-2.5z" />
  </svg>
);
